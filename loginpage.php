...
while($result=mysqli_fetch_assoc($data)){
    echo "<tr>
    <td><a href='displaylist.php?user_id=$result[user_id]&user_name=$result[user_name]' class='btn btn-info' role='button'><h8><center>Click to view your list</center></h8></a></td>
</tr>";
}
}
}
else {
  echo  "<font color='red'><h5><center>username and password mismatch</center></h5>";
}
}
?>
  </body>
